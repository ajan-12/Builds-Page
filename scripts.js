function populate() {
  ...
  var insides = '<caption><b style="font-size:20px">MC Spigot Plugins</b></caption><tr><th style="width:83%">Repository</th><th style="width:12%">Supported MC Versions</th><th style="width:5%">Build Status</th></tr>';
